...
const LandingHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-yellow-50 overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-72 h-72 bg-[#FFD600] rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center bg-[#FFD600] text-black px-6 py-2 rounded-full font-semibold text-sm mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight mb-6">
              ...
              <span className="text-[#FFD600]">dinheiro?</span>
            </h1>
          ...
          >
            <Button 
              ...
              size="lg" 
              className="bg-[#FFD600] hover:bg-[#FFC107] text-black font-bold text-lg px-8 py-4 rounded-full border-none shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
            >
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-gray-300 hover:border-[#FFD600] text-gray-700 hover:text-[#FFD600] font-semibold text-lg px-8 py-4 rounded-full bg-white/80 backdrop-blur-sm"
              asChild
            >
          ...
          >
            <div className="flex items-center justify-center space-x-3 bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              <Shield className="h-8 w-8 text-[#FFD600]" />
            ...
            <div className="flex items-center justify-center space-x-3 bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              <Clock className="h-8 w-8 text-[#FFD600]" />
              <div className="text-left">
            ...
            <div className="flex items-center justify-center space-x-3 bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              <TrendingUp className="h-8 w-8 text-[#FFD600]" />
              <div className="text-left">
